...
class EditingPanel(wx.SplitterWindow):
    ...
    def _init_coll_SubindexGridMenu_Items(self, parent):
        parent.Append(ID_EDITINGPANELMENU1ITEMS0,'Add subindexes')
        parent.Append(ID_EDITINGPANELMENU1ITEMS1,'Delete subindexes')
        parent.AppendSeparator()
        parent.Append(ID_EDITINGPANELMENU1ITEMS3,'Default value')
        if not self.Editable:
            parent.Append(ID_EDITINGPANELMENU1ITEMS4,'Add to DCF')
    ...
    def _init_coll_IndexListMenu_Items(self, parent):
        parent.Append(ID_EDITINGPANELINDEXLISTMENUITEMS0,'Rename')
        parent.Append(ID_EDITINGPANELINDEXLISTMENUITEMS2,'Modify')
        parent.Append(ID_EDITINGPANELINDEXLISTMENUITEMS1,'Delete')
